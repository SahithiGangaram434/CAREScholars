...
data%>%
  ...
  mutate(Year_Diabetes=YEAR-DIABETICAGE)%>%#calulating the year they were first diagnosed with diabetes
  mutate(Diabetes_Exposure=Death_Year-Year_Diabetes)#Calculating years they had diabetes
...
covariates_of_interest<-cbind(data_cmprsk$BMI, as_factor(data_cmprsk$sex))
