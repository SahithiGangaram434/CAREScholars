...
data_2<-data%>%
  ...
  select(exposure_birth, Mort_recode, Race, AGE, sex, Diabetes_Lifetime_Race, Diabetes_Lifetime, BMI_R_Cat, Education_recode, Earnings_recode, Smoking_recode, Insurance_Status, USBorn_Recode, PERWEIGHT, PSU, STRATA)%>%
...
cox_mod3<-svycoxph(Surv(AGE,exposure_birth, Mort_recode==TRUE) ~ Race + Diabetes_Lifetime_Race+ sex+ BMI_R_Cat+Education_recode+Earnings_recode+Smoking_recode+Insurance_Status+USBorn_Recode, design = data_weighted)
