...
data_practice<-data%>%
  ...
  mutate(Diabetes_Lifetime=relevel(as_factor(Diabetes_Lifetime), "Non-Diabetic"))%>%
...
cox_mod3<-coxph(Surv(exposure_birth, Mort_recode) ~ racea2 + sex + Diabetes_Lifetime+ BMI_R_Cat+Education_recode+Earnings_recode+Smoking_recode+Insurance_recode+USBorn_Recode, data = data_practice)
