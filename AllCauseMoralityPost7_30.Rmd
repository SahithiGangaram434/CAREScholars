...
cox_mod2<-coxph(Surv(exposure_birth, Diab_Und_ACM) ~ racea + SEX + BMI_R_Cat+Education_recode+Earnings_recode+Smoking_recode+Insurance_recode, data = data_practice)
